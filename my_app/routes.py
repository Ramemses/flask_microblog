...
from my_app.forms import LoginForm, RegistrationForm, EditProfileForm, EmptyForm, PostForm, ResetPasswordRequestForm
...
def register():
	...
	if form.validate_on_submit():
		...
		flash(_('Congratulations, you are registered user for now!'))	
		return redirect(url_for('login'))
...
def follow(username):
	...
	if form.validate_on_submit():
		...
		if user == current_user:
			...
			return redirect(url_for('user', username=usernmae))
